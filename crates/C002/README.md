...
Prime-related operations on gap tensors (e.g. prime membership/extraction across a tensor of GapTensorNode). Intended sibling to gap_tensor_core's CANDIDATE_PRIMES axis.
